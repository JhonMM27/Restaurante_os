...
urlpatterns = [
    # POST /api/comandas/crear/                  → Crear nueva comanda (Mesero)
    path('crear/',                    views.api_crear_comanda, name='api_crear_comanda'),
    # POST /api/comandas/web/crear/              → Crear nueva comanda (Web Pública)
    path('web/crear/',                views.api_crear_pedido_web, name='api_crear_pedido_web'),
